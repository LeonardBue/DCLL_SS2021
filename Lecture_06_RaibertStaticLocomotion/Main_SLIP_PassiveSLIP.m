...
%
% This script demonstrates the instability of the SLIP model when using a
% fixed angle of attack of pi/8
%
% INPUT:  - NONE
% OUTPUT: - NONE
%
...
%% Display results
figure('Name','SLIP model: dx and y of forward hopping with a fixed angle of attack of \pi/8','Units','Normalized','OuterPosition',[0.5,0.0,0.5,1.0]);
