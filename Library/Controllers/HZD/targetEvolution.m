...
%           dhD_th    -- derivative thereof wrt theta;
...
function [hD,dhD_dth,ddhD_ddth] = targetEvolution(th)
    ...
    %phi_D       = 0;    % Desired pitch angle (robot slows down and stops)
    phi_D       = -0.1; % Desired pitch angle (robot walks)
