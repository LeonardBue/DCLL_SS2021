...
function [phase,contPt] = discStates(z)
    phase  = z(1); % ['0','1','2'] The current phase of the model  (0 = flight after apex, 1 = stance, 2 = flight before apex)
    contPt = z(2); % [l_0] Horizontal position of the last ground contact   
end
% *************************************************************************
% *************************************************************************