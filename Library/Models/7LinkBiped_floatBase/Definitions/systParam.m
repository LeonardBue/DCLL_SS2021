...
function varargout = systParam(p)
    ...
    if nargout == 1
        ...
        varargout{1} = p;
    elseif nargout > 1
        % Call sequence:   [g,l1,l2,l3,l4,m1,m2,m3,m4,j1,j2,j3,j4] = systParam(p);
